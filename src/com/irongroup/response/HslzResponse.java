...
public class HslzResponse {
	private static Logger  logger= Logger.getLogger(HslzResponse.class);
...
//		mc.init();
		...
		response.append("<Description><![CDATA[]]></Description>");
		response.append("<PicUrl><![CDATA[]]></PicUrl>");
		response.append("<Url><![CDATA[http://irong.sinaapp.com/mock?action=hslz]]></Url>");
		response.append("</item>");
