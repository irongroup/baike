...
public class KhbdResponse {
	private static Logger  logger= Logger.getLogger(KhbdResponse.class);
...
//		mc.init();
		...
		response.append("<Description><![CDATA[]]></Description>");
		response.append("<PicUrl><![CDATA[]]></PicUrl>");
		response.append("<Url><![CDATA[http://irong.sinaapp.com/mock?action=khbd]]></Url>");
		response.append("</item>");
