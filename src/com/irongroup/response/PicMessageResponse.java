...
public class PicMessageResponse {
	private static Logger  logger= Logger.getLogger(PicMessageResponse.class);
...
//		mc.init();
		...
		for (int i = 0; i < list.size(); i++) {
			...
			response.append(i+"."+json.getString("name")+"-"+json.getString("author")+"("+json.getString("rate")+")");
			response.append("]]></Title>");
			//response.append("<Description><![CDATA["+json.getString("year")+json.getString("bookstat")+"]]></Description>");
		...
		//response.append("<Description><![CDATA["+json.getString("year")+json.getString("bookstat")+"]]></Description>");
		//response.append("<PicUrl><![CDATA["+json.getString("bookpic")+"]]></PicUrl>");
		response.append("<Url><![CDATA[http://irong.sinaapp.com/mock?action=getAll]]></Url>");
		response.append("</item>");
