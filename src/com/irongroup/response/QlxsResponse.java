...
public class QlxsResponse {
	private static Logger  logger= Logger.getLogger(QlxsResponse.class);
...
//		mc.init();
		...
		response.append("<Description><![CDATA[]]></Description>");
		response.append("<PicUrl><![CDATA[]]></PicUrl>");
		response.append("<Url><![CDATA[http://irong.sinaapp.com/mock?action=qlxs]]></Url>");
		response.append("</item>");
